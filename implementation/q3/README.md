...
```powershell
$env:PYTHONPATH = "$PWD\.q3-runtime;$PWD\implementation\q3\code"
& 'C:\Users\29919\AppData\Local\Python\bin\python.exe' -m q3.run_q3_final --mode formal --clean
```
...
```powershell
$env:PYTHONPATH = "$PWD\.q3-runtime;$PWD\implementation\q3\code"
& 'C:\Users\29919\AppData\Local\Python\bin\python.exe' -m q3.run_q3_final --mode reproduce
```
