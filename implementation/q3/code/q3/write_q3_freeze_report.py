...
def write_report() -> Path:
    ...
    reproduction = _read(root, "q3_reproduction_report.json") if (root / "q3_reproduction_report.json").exists() else {}
    ...
    lines = [
        ...
        "## 2. C2-A result", "",
        f"- status: **{final['c2a_summary']['status']}**", f"- candidates: {final['c2a_summary']['candidate_count']}",
        f"- joint-feasible candidates: {final['c2a_summary']['joint_feasible_count']}", "",
        "## 3. C2-B result", "",
        f"- status: **{final['c2b_summary']['status']}**", f"- candidates: {final['c2b_summary']['candidate_count']}",
